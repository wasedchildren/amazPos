              ...
              <el-tabs class="el-scol">
                  <el-tab-pane label="点餐">
                      ...
                      <div class="clas-mar">
                        ...
                        <el-button type="danger" round @click="delAllGood()">删除</el-button>
...
.often-goods-list ul li {
  ...
  cursor: pointer;
  transition: all .3s;
  box-shadow: 1px 1px 3px 1px rgba(6, 6, 19, 0.055);
}
.often-goods-list ul li:hover{
  transform: translatex(-5px);
  box-shadow: 3px 3px 3px 3px rgba(1, 1, 31, 0.505);
...
.cookList li {
  ...
  cursor: pointer;
  transition: all .3s;
  box-shadow: 1px 1px 1px 1px  rgba(6, 6, 19, 0.3);
}
.cookList li:hover{
